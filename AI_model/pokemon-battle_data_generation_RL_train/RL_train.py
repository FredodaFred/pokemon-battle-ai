...
class PokemonMakeDownEnv:
    def __init__(self):
        ...
        self.team1 = [Pokemon(6)] # spitfire_dragon
    ...
    def step(self, action):
        ...
        try:
            done = self.engine.run_turn(action)
        except:
            done = True
        ...
        if done == True:
            ...
            if not win:
                ...
                reward = -300  # Spitfire Dragon lost
                # if next_state[2] >= 6:
                #     reward = -50
            elif win:
...
agent.model.save("/Users/zch/Downloads/spitfire_dragon_model5.h5")